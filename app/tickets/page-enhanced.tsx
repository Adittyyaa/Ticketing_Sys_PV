...
import { Alert, Button, Input, Select, Spin, Tag, Space, Card, Row, Col, Segmented } from 'antd'
import { FileText, Plus, Search, Filter, User, Clock, AlertCircle } from 'lucide-react'
...
export default function TicketsPage() {
  ...
  }, [allTickets, predefinedFilter, searchQuery, statusFilter, priorityFilter, categoryFilter, typeFilter, user])
